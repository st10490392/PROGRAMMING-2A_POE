...
public class QuizService
{
    ...
    private void SeedQuestions()
    {
        var seed = new[]
        {
            new QuizQuestion { Question = "What should you do with a suspicious email link?", Answer = "Do not click it and verify the sender" },
            new QuizQuestion { Question = "What is the strongest way to protect multiple accounts?", Answer = "Use unique, strong passwords and a password manager" },
            new QuizQuestion { Question = "What does VPN stand for?", Answer = "Virtual private network" },
            new QuizQuestion { Question = "What is phishing?", Answer = "A scam that tricks you into giving personal information" }
        };
    ...
    {
        _attemptCount++;
        if (string.Equals(question.Answer.Trim(), userAnswer.Trim(), StringComparison.OrdinalIgnoreCase))
        {
            _correctCount++;
            SaveResult(true);
            return true;
